...
def main(mpi_comm):
    ...
    solver_options = {'max_iter': '400', 'precision': '1e-6', 'post_check_solves_system': '1e-5', 'type': 'bicgstab.ilut',
     'verbose': '1', 'preconditioner.iterations': '2', 'preconditioner.relaxation_factor': '1.0', }
