...
def discretize():
    ...
    from dune.xt.functions import make_constant_function_1x1, make_constant_function_2x2, make_expression_function_1x1, make_checkerboard_function_1x1
    ...
    values[0] = [1.]
    lmbda = make_checkerboard_function_1x1(grid_provider=grid, lower_left=[0, 0], upper_right=[1, 1],
    ...
    f = make_expression_function_1x1(grid, 'x', '1', order=3, name='force')
